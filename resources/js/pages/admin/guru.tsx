                        ...
                        <table className="w-full text-left text-sm">
                            <thead className="sticky top-0 z-10 border-b border-neutral-100 bg-neutral-50 dark:border-zinc-800 dark:bg-zinc-900">
                                <tr>
                                    ...
                                    <th className="px-6 py-3.5 text-[10px] font-black tracking-widest text-neutral-400 uppercase dark:text-neutral-500">NIP</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black tracking-widest text-neutral-400 uppercase dark:text-neutral-500">No. HP</th>
                                    <th className="px-6 py-3.5 text-[10px] font-black tracking-widest text-neutral-400 uppercase dark:text-neutral-500">Status Wali</th>
                            ...
                            <tbody className="divide-y divide-neutral-100 dark:divide-zinc-800/60">
                                {filteredTeachers.length > 0 ? (
                                    filteredTeachers.map((t) => (
                                        <tr key={t.id} className="transition-colors hover:bg-violet-50/20 dark:hover:bg-violet-950/10">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    {t.foto ? (
                                                        <img
                                                            src={t.foto}
                                                            alt={t.name}
                                                            className="size-11 rounded-2xl object-cover ring-2 ring-neutral-100 dark:ring-zinc-800"
                                                        />
                                                    ) : (
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex justify-end gap-1.5">
                                                    ...
                                                    <Button size="sm" variant="outline" className="h-8 w-8 rounded-xl border-rose-200 text-rose-500 hover:bg-rose-50 dark:border-rose-900/40 dark:text-rose-400 dark:hover:bg-rose-950/20 cursor-pointer" onClick={() => handleDelete(t.id)}>
