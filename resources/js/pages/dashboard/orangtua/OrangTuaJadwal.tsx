...
export default function OrangTuaJadwal({ childName, jadwals }: OrangTuaJadwalProps) {
    return (
        <Card className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 mt-6">
            <CardHeader>
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <CardTitle className="text-xl font-bold">Jadwal Pelajaran {childName}</CardTitle>
