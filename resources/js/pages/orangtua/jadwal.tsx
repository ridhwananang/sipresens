...
import OrangTuaJadwal, { ScheduleItem } from '../dashboard/orangtua/OrangTuaJadwal';
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col gap-1">
                <h1 className="text-3xl font-extrabold tracking-tight text-neutral-900 dark:text-neutral-50">
                    Jadwal Pelajaran Kelas Anak
                </h1>
                <p className="text-sm text-neutral-500">
                    Mata pelajaran dan guru pengampu anak Anda sesuai hari mengajar.
                </p>
            </div>
            ...
            <div className="max-w-4xl">
                <OrangTuaJadwal childName={activeChild.name} jadwals={jadwals} />
            </div>
        </div>
    );
}
