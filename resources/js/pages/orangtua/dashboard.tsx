...
export default function OrangTuaDashboard({
    ...
    if (children.length === 0) {
        return (
            <div className="animate-fade-in flex flex-col items-center justify-center space-y-4 py-20 text-neutral-500">
    ...
    return (
        <div className="animate-fade-in space-y-5 pb-6 text-left">
            ...
            <div className="flex flex-col gap-0.5">
                ...
                <h1 className="mt-2 text-xl font-black text-neutral-800 dark:text-neutral-100">
                    Wali Murid, {parent.name} 👋
                </h1>
                <p className="text-neutral-450 text-[11px] leading-relaxed font-medium dark:text-neutral-500">
            ...
            {children.map((child) => (
                <div
                    key={child.id}
                    className="space-y-4 rounded-3xl border border-neutral-100 bg-white p-4 shadow-xs dark:border-zinc-900 dark:bg-zinc-900/40"
                >
                    {/* Child Identity Card */}
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            <h2 className="truncate text-sm font-black text-neutral-900 dark:text-neutral-100">
                                {child.name}
                            </h2>
                        ...
                        <ChevronRight className="size-4 shrink-0 text-neutral-300 dark:text-zinc-700" />
                    </div>
                    ...
                    <div className="space-y-2.5">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[10px] font-medium tracking-widest text-neutral-400 uppercase dark:text-neutral-500">
                                Sedang Berlangsung
                            </span>
                        </div>
                        ...
                        {child.active_jadwal ? (
                            /* Active class card */
                            <div className="relative flex items-center gap-3 overflow-hidden rounded-xl border border-neutral-200 bg-white px-3 py-2.5 dark:border-neutral-700/60 dark:bg-neutral-900">
                                {/* Left accent bar */}
                                <div className="absolute top-0 bottom-0 left-0 w-[3px] rounded-l-xl bg-violet-400 dark:bg-violet-500" />

                                {/* Book icon */}
                                <div className="ml-1.5 flex size-[34px] shrink-0 items-center justify-center rounded-lg border border-neutral-200 bg-violet-50 dark:border-neutral-700/40 dark:bg-violet-500/15">
                            ...
                            /* Empty state */
                            <div className="flex items-center gap-2.5 rounded-xl border border-neutral-200 bg-white px-3 py-2.5 dark:border-neutral-700/60 dark:bg-neutral-900">
                                <div className="flex size-[30px] shrink-0 items-center justify-center rounded-lg bg-neutral-100 dark:bg-neutral-800">
