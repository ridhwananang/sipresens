    ...
    switch (status) {
        case 'hadir':
            return {
                ...
                cardActive:
                    'bg-emerald-50 border-emerald-300 dark:bg-emerald-950/30 dark:border-emerald-500 shadow-md shadow-emerald-500/5',
            };
        case 'izin':
            return {
                ...
                cardActive:
                    'bg-blue-50 border-blue-300 dark:bg-blue-950/30 dark:border-blue-500 shadow-md shadow-blue-500/5',
            };
        case 'sakit':
            return {
                ...
                cardActive:
                    'bg-amber-50 border-amber-300 dark:bg-amber-950/30 dark:border-amber-500 shadow-md shadow-amber-500/5',
            };
        case 'alpa':
            return {
                ...
                cardActive:
                    'bg-rose-50 border-rose-300 dark:bg-rose-950/30 dark:border-rose-500 shadow-md shadow-rose-500/5',
            };
        default:
            return {
                bg: 'bg-slate-50 dark:bg-zinc-850',
                text: 'text-slate-600 dark:text-neutral-450',
                border: 'border-slate-200 dark:border-zinc-800',
                accent: 'bg-neutral-500',
                cardActive:
                    'bg-slate-50 border-slate-300 dark:bg-zinc-900 dark:border-zinc-700',
            };
    }
};
...
export default function OrangTuaRiwayatPage({
    ...
    return (
        <div className="animate-fade-in dark:text-neutral-250 space-y-5 pb-28 text-slate-900">
            <Head title="Riwayat Kehadiran Anak" />
            ...
            <div className="flex flex-col gap-1 text-left">
                ...
                <h2 className="mt-2 text-xl font-black tracking-tight text-slate-900 dark:text-neutral-50">
                    Riwayat Kehadiran Anak
                </h2>
                <div className="dark:text-neutral-450 flex flex-wrap items-center gap-1.5 text-xs font-medium text-slate-600">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 rounded-xl px-3.5 py-2 text-xs font-bold transition-all active:scale-95 ${
                                (selected_child_id ?? children[0].id) === c.id
                                    ...
                                    : 'bg-slate-100 text-slate-600 hover:bg-slate-200 dark:bg-zinc-900 dark:text-neutral-400 dark:hover:bg-zinc-800 border border-slate-200 dark:border-zinc-800'
                            }`}
            ...
            <div className="space-y-4 rounded-3xl border border-slate-200 bg-white p-5 text-left shadow-sm dark:border-zinc-800/80 dark:bg-zinc-900">
                <div className="flex items-center gap-1.5">
                    ...
                    <h3 className="text-sm font-black text-slate-900 dark:text-neutral-200">
                        Rekap Presensi
                    </h3>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <label className="block text-[10px] font-bold tracking-wider text-slate-500 uppercase dark:text-neutral-500">
                            Pilih Bulan
                        </label>
                        <div className="relative">
                            <select
                                ...
                                className="w-full cursor-pointer appearance-none rounded-2xl border border-slate-200 bg-white px-3.5 py-3 pr-10 text-xs font-bold text-slate-800 focus:ring-2 focus:ring-violet-500 focus:outline-none dark:border-zinc-800 dark:bg-zinc-950 dark:text-neutral-200"
                            >
                            ...
                            <div className="dark:text-neutral-550 pointer-events-none absolute inset-y-0 right-3.5 flex items-center text-slate-400">
                    ...
                    <button
                        ...
                        className={`flex cursor-pointer items-center gap-3 rounded-2xl border p-3.5 text-left transition-all duration-300 active:scale-95 ${
                            selectedStatus === 'hadir'
                                ...
                                : 'border-slate-200 bg-slate-50 dark:border-zinc-800/60 dark:bg-zinc-950/30'
                        }`}
                    >
                        <div
                            className={`shrink-0 rounded-xl p-2 ${
                                selectedStatus === 'hadir'
                                    ...
                                    : 'bg-emerald-50 border border-emerald-250 text-emerald-600 dark:bg-emerald-950/20 dark:text-emerald-400'
                            }`}
                        >
                        ...
                        <div
                            className={`shrink-0 rounded-xl p-2 ${
                                selectedStatus === 'izin'
                                    ...
                                    : 'bg-blue-50 border border-blue-250 text-blue-600 dark:bg-blue-950/20'
                            }`}
                        >
                        ...
                        <div
                            className={`shrink-0 rounded-xl p-2 ${
                                selectedStatus === 'sakit'
                                    ...
                                    : 'bg-amber-50 border border-amber-250 text-amber-600 dark:bg-amber-950/20'
                            }`}
                        >
                        ...
                        <div
                            className={`shrink-0 rounded-xl p-2 ${
                                selectedStatus === 'alpa'
                                    ...
                                    : 'bg-rose-50 border border-rose-255 text-rose-600 dark:bg-rose-950/20'
                            }`}
                        >
